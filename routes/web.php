...
Route::get('SurveyStatistcs/{id}/edit', [SurveyStatisticsController::class, 'edit'])->where('id', '[0-9]+')->name('Statistics.edit')->middleware('can:edit-forest');
Route::patch('SurveyStatistcs/update/{id}' , [SurveyStatisticsController::class, 'update'])->where('id', '[0-9]+')->name('Statistics.update');
Route::delete('SurveyStatistcs/delete/{id}', [SurveyStatisticsController::class, 'destroy'])->where('id', '[0-9]+')->name('Statistics.destroy')->middleware('can:admin');
Route::get('SurveyStatistcs/create', [SurveyStatisticsController::class, 'create'])->name('Statistics.create')->middleware('can:admin');
