...
class CreateStatisRequest extends FormRequest
{
    ...
    public function messages()
    {
        return[
            ...
            'very_dissatisfied_pct.numeric' => '很滿意(%) 必須是數值',
